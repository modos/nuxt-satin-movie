<template>
    <div class="genres w-3/6">
        <div class="genres__heading flex flex-row-reverse justify-between px-2 py-1">
            <div class="genres__heading__title flex flex-row-reverse gap-3">
                <svg width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    class="bi bi-theater-mask" viewBox="0 0 640 512">
                    <path
            ...
            <div class="genres__heading__switch">
                <a href="#" class="genres__heading__switch--active">فیلم</a>
                <a href="#">سریال</a>
            </div>
        </div>
