<template>
    <div class="posts-list-item flex flex-col">
        ...
        <div class="flex flex-row-reverse mt-5">
            <div class="posts-list-item__container flex flex-row p-2 basis-3/4">
        ...
        <div class="posts-list-item__thumbnail basis-1/4 flex flex-col justify-center items-center">
           <a>
            <img src="https://filmsara.info/wp-content/uploads/2023/02/jesus-revolution-10391-210x315.jpg" width="210"
                height="315">
           </a>
        </div>
        </div>
